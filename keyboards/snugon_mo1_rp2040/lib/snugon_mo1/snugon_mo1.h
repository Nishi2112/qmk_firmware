...
enum snugon_mo1_keycodes {
    ...
    // reset & save
    KBC_RST = QK_KB_0, // snugon_mo1 configuration: reset to default
    KBC_SAVE = QK_KB_1, // snugon_mo1 configuration: save to EEPROM
    ...
    SCRL_DVI = QK_KB_8, // Increment scroll divider (slower)
    SCRL_DVD = QK_KB_9, // Decrement scroll divider (faster)

    // no move mode
    NO_MOVE = QK_KB_10, // disable cursor movement

    // scroll invert
    SCRL_INV = QK_KB_11,

    // report rate
    RPRT_RTI = QK_KB_12, // Increase report rate
    RPRT_RTD = QK_KB_13, // Decrease report rate
